...
Adicione uma propriedade `width` a todo o cartão e defina-o com um valor absoluto de 245px. Use a classe `fullCard` para selecionar o elemento.

# --hints--

Seu código deve alterar a propriedade `width` do cartão para 245 pixels usando o seletor de classe `fullCard`.
