...
title: Crie uma linha horizontal usando o elemento hr
challengeType: 0
...
**Nota:** Em HTML, `hr` é uma tag de fechamento automático e, portanto, não precisa de uma tag de fechamento.
